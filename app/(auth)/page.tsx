      ...
      <div className="w-1/4 min-w-[425px] flex flex-col items-center justify-between bg-[#F9F9F999]">
        ...
        <div className="flex flex-col w-full max-w-xs gap-4 px-6">
          ...
          <button
            ...
            {/* ...X SVG icon ... */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-twitter-icon lucide-twitter"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
